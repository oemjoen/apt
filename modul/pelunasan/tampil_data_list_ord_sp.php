...
<!--				<td align='center'>";if (empty($r_data[kodepo_beli])){echo "<a href='javascript:editRow(\"{$r_data[NoSP]}\")' ><img src='icon/thumb_up.png' border='0' id='edit' title='Edit' width='12' height='12' ></a>";}echo "</td>
