<script type="text/javascript" src="modul/t_orderSP/ajax.js"></script>
<script type="text/javascript">	
	
	//$("#data").load('modul/t_orderSP/cari_nomor.php?kode='+$("#txt_kode_beli").val());
