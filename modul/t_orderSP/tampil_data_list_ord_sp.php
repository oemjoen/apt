<script type="text/javascript">
	...
	function lihatRow(ID){
		...
		var apt	= $("#textuser").val();
	   	...
	   	$.ajax({
			type	: "GET",
			url		: "modul/t_orderSP/tampil_data_list_ord_sp.php",
	...
	echo "<table width='100%'>
		...
		echo "<td align='right'>Halaman :";
			for ($h = 1; $h <= $max; $h++) {
                    ...
                    onClick="$.get('modul/t_orderSP/tampil_data_list_ord_sp.php?cabang=<?php echo $cabang;?>&hal=<?php echo $list[$h]; ?>', 
	...
	echo "</td>";
		...
		echo "<td align='right'>Halaman :";
			for ($h = 1; $h <= $max; $h++) {
					$list[$h] = $lim * $h - $lim;
					echo " <a href='javascript:void(0)' ";?> 
                    onClick="$.get('modul/t_orderSP/tampil_data_list_ord_sp.php?cabang=<?php echo $cabang;?>&kode=<?php echo $_GET['kode'];?>
